...
export const CitizenDashboard: React.FC<CitizenDashboardProps> = ({ user, onLogout }) => {
  ...
  const handleSubmitComplaint = () => {
    if (!newComplaint.title || !newComplaint.imageUrl) {
      alert('Please provide a title and capture an image');
      return;
    }
    ...
    const newComplaintData: Complaint = {
      ...
      description: newComplaint.description || 'No additional description provided',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-orange-50 to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* Report Waste Tab - Default Landing */}
        {activeTab === 'report' && (
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100">
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-gray-800 mb-2">Report Waste Issue</h2>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Additional details about the waste issue (optional)"
                    rows={4}
                ...
                <div className="flex items-center justify-center text-sm text-gray-600 bg-blue-50 p-4 rounded-2xl border border-blue-200">
                  ...
                  <span className="font-medium">📍 Location will be captured automatically via Google Maps</span>
                </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
              ...
              {userComplaints.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 mb-6">Start by reporting your first waste issue!</p>
                  <button
                    onClick={() => setActiveTab('report')}
          ...
          <div className="space-y-6">
            ...
            {userComplaints.length === 0 ? (
              <div className="bg-white rounded-3xl p-12 shadow-lg border border-gray-100 text-center">
                ...
                <p className="text-gray-500 mb-8">Start making a difference by reporting your first waste issue!</p>
                <button
                  onClick={() => setActiveTab('report')}
