...
interface CitizenDashboardProps {
  user: any;
  onLogout: () => void;
  defaultTab?: 'dashboard' | 'report' | 'complaints' | 'store';
}

export const CitizenDashboard: React.FC<CitizenDashboardProps> = ({ user, onLogout, defaultTab = 'dashboard' }) => {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'report' | 'complaints' | 'store'>(defaultTab);
