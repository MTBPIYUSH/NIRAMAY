...
export const AuthPage: React.FC<AuthPageProps> = ({ onAuthSuccess }) => {
  ...
  const getRestrictedMessage = () => {
    if (selectedRole === 'admin') {
      return "This portal is restricted to authorized municipal authorities. Login credentials are pre-assigned by the system administrators. For access-related queries, please contact technical support.";
    } else {
      return "This login is exclusively for registered municipal workers. Your credentials have been provided by your supervisor. If you haven't received your login details, please contact your municipal authority.";
    }
  };
